    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ActiveDoctors", x => x.userId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RegisteredrId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    MedicalService = table.Column<string>(type: "nvarchar(max)", nullable: false),
